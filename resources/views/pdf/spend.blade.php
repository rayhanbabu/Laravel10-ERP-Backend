...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <th align="left" width="230">Spend Category </th>
            <th align="right" width="60">Amount</th>
            <th align="center" width="160">Spent Type</th>   
        </tr>

     @foreach($data as $row)
        <tr>
            <td align="left">{{$row->date}} </td>
            <td align="left">{{$row->scategory_name}} {{$row->reff}}</td>
            <td align="right">{{$row->amount}}TK</td>
            <td align="left">{{$row->teacher_name}}</td>  
        </tr>
    @endforeach
