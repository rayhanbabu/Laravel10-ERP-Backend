...
<div class="card mt-3 mb-0"> 
   <div class="card-header ">
      <div class="row">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Site View </h5></div>
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 my-2">
               ...
               <input type="text" name="site_name" id="site_name" class="form-control" placeholder="" required>
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
                <label for="roll">Name<span style="color:red;"> * </span></label>
                <input type="text" name="site_name" id="edit_site_name" class="form-control" placeholder="" required>
                <p class="text-danger error_site_name"></p>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>site Status</b></label>
                    <select class="form-select" name="site_status" id="edit_site_status" aria-label="Default select example">
...
<script>  
  $(document).ready(function(){ 
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/site/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
