...
@section('scategory','active')
@section('content')

<div class="card mt-3 mb-0"> 
   <div class="card-header ">
      <div class="row">
                 <div class="col-sm-3 my-2"> <h5 class="mt-0">Spend category View </h5></div>
 ...
 <table id="employee_data"  class="table table-bordered table-hover table-sm shadow">
    <thead>
       <tr>
          ...
          <th width="25%" class="sorting" data-sorting_type="asc" data-column_name="scategory_name" style="cursor: pointer"> Name 
                <span id="scategory_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 my-2">
               ...
               <input type="text" name="scategory_name" id="scategory_name" class="form-control" placeholder="" required>
               <p class="text-danger error_scategory_name"></p>
            </div>
    ...
    <div class="modal-content">
      ...
      <form  method="POST" id="edit_employee_form" enctype="multipart/form-data">
         ...
         <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-12 my-2">
                <label for="roll">Name<span style="color:red;"> * </span></label>
                <input type="text" name="scategory_name" id="edit_scategory_name" class="form-control" placeholder="" required>
                <p class="text-danger error_scategory_name"></p>
            </div>
            ...
            <div class="col-lg-6 my-2">
                  <label class=""><b>scategory Status</b></label>
                    <select class="form-select" name="scategory_status" id="edit_scategory_status" aria-label="Default select example">
  ...
  $(document).ready(function(){ 
    ...
    $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')} });
       ...
       $("#add_employee_form").submit(function(e) {
        ...
        $.ajax({
          type:'GET',
          url:'/admin/scategory_edit',
          data: {
            id: id,
          },
          success: function(response){
              //console.log(response);
              $("#edit_scategory_name").val(response.data.scategory_name);
              $("#edit_scategory_status").val(response.data.scategory_status);
   ...
   function fetch_data(page, sort_type="", sort_by="", search="",range=""){
    $.ajax({
      url:"/admin/scategory/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&search="+search+"&range="+range,
     beforeSend : function()
               {
               $('.loader_page').show();
               },
